#!/usr/bin/env python3
"""
Test Social Analyst with MCP Integration

This script tests the Social MCP server independently.
"""
...
print()
print("=" * 80)
print("🧪 SOCIAL ANALYST MCP INTEGRATION TEST")
print("=" * 80)
print()
...
TICKER = "NVDA"
DATE = "2024-11-01"
ANALYSTS = ["social"]  # Only Social analyst
...
config.update({
    ...
    # Use OpenAI for news/social (more reliable than alpha_vantage)
    "data_vendors": {
        "core_stock_apis": "yfinance",
        "technical_indicators": "yfinance",
        "fundamental_data": "yfinance",
        "news_data": "openai",  # Social uses news tools
    },
})
...
print(f"   Date: {DATE}")
print(f"   Analyst: Social only")
print(f"   News Vendor: OpenAI (for social sentiment)")
print()

async def run_test():
    """Run the Social analyst MCP test."""
    ...
    try:
        # Step 1: Initialize
        print("-" * 80)
        print("STEP 1: Initializing TradingAgents with MCP (Social Server)...")
        print("-" * 80)
        ...
        # Step 2: Run Analysis
        print("-" * 80)
        print("STEP 2: Running Social analysis via MCP...")
        print("-" * 80)
...
if social_report:
    print(f"✅ Social Report: {len(social_report)} characters")
    print()
    print("💬 Social Report Preview:")
    print("-" * 80)
    print(social_report[:500] + "..." if len(social_report) > 500 else social_report)
    print("-" * 80)
else:
    print("❌ Social Report: NOT GENERATED")
...
# Summary
print("=" * 80)
print("📊 SOCIAL ANALYST MCP TEST SUMMARY")
print("=" * 80)
print()

if social_report and decision:
    print("🎉 TEST PASSED! ✅")
    print()
    ...
    print("   - Social MCP Server: WORKING")
    print("   - Tool Routing: WORKING")
    print("   - Data Fetching: WORKING")
    print("   - Report Generation: WORKING")
    print()
    print("All individual analyst tests complete!")
else:
